...
namespace dataflow
{
    public static class PushPull_BlockingEverything
    {
        /*                 [Transform]
         *  [Producer] - <     ...     > - [Action]  
         *                 [Transform]
        ...
        private const int TransformCapacity = 30;//Unbounded;
        private const int TransformParallelism = 1;
        private const int TransformRate = 2;

        private const int ActionCapacity = 20;//Unbounded;
        private const int ActionParallelism = 1;
        private const int ActionRate = 1;
        ...
        static int TransformFn(int i)
        {
            ...
            Thread.Sleep(1000 / TransformRate);
            return i;
        }
        ...
        static PushPull_BlockingEverything() => Transform.LinkTo(Action);
        ...
        internal static void Run()
        {
            ...
            {
                var result = Transform.SendAsync(i).Result; //just like out `SendSync` extensions method
                if (!result) throw new Exception("Failed to send " + i);
                sent++;
                Thread.Sleep(1000 / ProducingRate);
            }
        ...
        private static void Render()
        {
            ...
            Console.WriteLine("transformed: {0:000} " + ProgressBar(transformed / (double) MaxItems, maxLen),
                transformed);
